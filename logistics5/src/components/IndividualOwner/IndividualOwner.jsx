...
const FindLoads = () => {
  const nearbyLoads = [
    { name: 'Rakesh', truckType: 'truck type 1', pickup: 'Hyderabad to Delhi', salary: '20000' },
    { name: 'Adil', truckType: 'truck type 2', pickup: 'Mumbai to Ooty', salary: '15000' },
    { name: 'Suresh', truckType: 'truck type 3', pickup: 'Chennai to Banglore', salary: '10000' },
    { name: 'Bajrangi', truckType: 'truck type 4', pickup: 'Vizag to Jaipur', salary: '15000' },
    { name: 'Raghu', truckType: 'truck type 5', pickup: 'Trivandrum to Hyderabad', salary: '10000' },
    { name: 'Deepak', truckType: 'truck type 4', pickup: 'Mumbai to Pune', salary: '7500' },
    { name: 'vinod', truckType: 'truck type 2', pickup: 'Bom to Assam', salary: '2312' },
  ];
